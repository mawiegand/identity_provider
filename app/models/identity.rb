...
class Identity < ActiveRecord::Base
  ...
  attr_accessible :nickname, :firstname, :surname, :activated, :deleted, :staff, :insider_since, :platinum_lifetime_since, :supporter_since, :banned, :ban_reason, :ban_ended_at, :generic_email, :generic_nickname, :generic_password, :gc_player_id, :gc_rejected_at, :gc_player_id_connected_at, :fb_player_id, :fb_rejected_at, :fb_player_id_connected_at, :as => :staff
  attr_accessible *accessible_attributes(:staff), :email, :admin, :password, :password_confirmation, :as => :admin
  attr_accessible :nickname, :password, :password_confirmation, :platinum_lifetime_since, :supporter_since, :as => :game
  ...
  attr_readable *readable_attributes(:default), :insider_since, :platinum_lifetime_since, :created_at,               :as => :game
